import {
  QuickStats, WeatherMap, ForecastCard, MarineCard,
  SportsCard, EventsCard, AnnouncementsCard, AudioBriefingCard,
} from "@/components/home";
import { MOCK_SPORTS, MOCK_EVENTS, MOCK_ANNOUNCEMENTS, MOCK_AUDIO } from "@/components/home/mock-data";
...
export default async function Home() {
  const [weather, marine] = await Promise.all([fetchHomepageWeather(), fetchHomepageMarine()]);
  return (
    <div className="page-container">
      ...
      <div className="dashboard-grid">
        ...
        <div className="grid-span-full"><WeatherMap /></div>
